...
<html>
	...
	<body>
	<form id="mainForm" action="${ctx}/snaker/task!active.action" method="get">
		<table width="100%" border="0" align="center" cellpadding="0"
				class="table_all_border" cellspacing="0" style="border-bottom: 0px; margin-bottom: 0px">
			<tr>
				<td class="td_table_top" align="left">
					待办任务<font color="red">[共:${majorTotal }项]&nbsp;&nbsp;<a href="${ctx}/snaker/task!activeTaskList.action?taskType=0">更多...</a></font>
				</td>
			</tr>
		</table>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<c:forEach items="${majorWorks}" var="item">
				<tr>
					...
					<td class="td_list_2" align=left nowrap>
						<a href="${ctx}/snaker/process!display.action?processId=${item.processId }&orderId=${item.orderId} " class="btnPict" title="查看流程图">查看流程图</a>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td class="td_table_top" align="left">
					协办任务<font color="red">[共:${aidantTotal }项]&nbsp;&nbsp;<a href="${ctx}/snaker/task!activeTaskList.action?taskType=1">更多...</a></font>
				</td>
			</tr>
		</table>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td class="td_table_top" align="left">
					抄送任务<font color="red">[共:${ccorderTotal }项]&nbsp;&nbsp;<a href="${ctx}/snaker/task!activeCCList.action">更多...</a></font>
				</td>
			</tr>
		</table>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<c:forEach items="${ccorderWorks}" var="item">
				<tr>
					...
					<td class="td_list_2" align=left nowrap>
						<a href="${ctx}/snaker/process!display.action?processId=${item.processId }&orderId=${item.id} " class="btnPict" title="查看流程图">查看流程图</a>
						...
						<a href="${ctx}/snaker/flow!ccread.action?id=${item.id}&url=/snaker/task/active " class="btnRead" title="关闭">关闭</a>
					</td>
				</tr>
			</c:forEach>
