...
<html>
	<head>
		...
		<script src="${ctx}/workflow/sanker/jquery-1.8.3.min.js" type="text/javascript"></script>
		<script src="${ctx}/workflow/snaker/table.js" type="text/javascript"></script>
	</head>

	<body>
	<form id="mainForm" action="${ctx}/snaker/task!activeTaskList.action" method="get">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<c:forEach items="${page.result}" var="item">
				<tr>
					...
					<td class="td_list_2" align=left nowrap>
						<a href="${ctx}/snaker/process!display.action?processId=${item.processId }&orderId=${item.orderId} " class="btnView" title="查看">查看</a>
