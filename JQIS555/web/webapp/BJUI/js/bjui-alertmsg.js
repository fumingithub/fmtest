    ...
    Alertmsg.prototype.TOOLS = function() {
        ...
        var tools = {
            ...
            open: function(type, msg, buttons) {
                ...
                $box = $newbox
                $box.css({top:-$box.outerHeight()}).show().animate({top:'0px'}, 600)
                ...
                if (options.types.info == type || options.types.correct == type) {
                    timer = setTimeout(function() { $tools.close() }, BJUI.alertMsg.alertTimeout)
                } else {
                    $alertbg.show()
                }
            ...
            close: function() {
                ...
                $box.animate({top:-$box.height()}, 600, function() {
                    $alertbg.hide()
                    $(this).hide().empty()
                })
            }
