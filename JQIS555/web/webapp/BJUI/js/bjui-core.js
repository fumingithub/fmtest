...
+function ($) {
    ...
    var BJUI = {
        ...
        alertMsg: {displayPosition:'topcenter', alertTimeout: 3000}, //alertmsg display position && close timeout
        ajaxTimeout: 8000,
        ...
        loadLogin: function() {
            ...
            $('body').dialog({id:'bjui-login', url:login.url, title:'登录', width:420, loginInfo:200, mask:true})
        },
