...
+function ($) {
	            ...
	            $.ajax({
	                ...
	                success  : function(response) {
	                    ...
	                    if (!json[BJUI.keys.statusCode]) {
	                        ...
	                        setTimeout(function(){$ajaxMask.fadeOut('normal', function() {
	                            $(this).remove()
	                        })},3000)
    ...
    $.extend(String.prototype, {
        ...
        if (url.indexOf("?") == -1) {
            ...
            for(var i = 0; i < strs.length; i ++) {
                ...
                var item={'key':strs[i].split("=")[0],'value':decodeURIComponent(strs[i].split("=")[1])}
    ...
    $.extend(Date.prototype,{
        ...
        IsValidDate:function(dValue,t){
            ...
            r[3]=r[3]-1;
            if(t==2)
                d= new Date(r[1],r[3],r[4],r[5],r[6]);
            else if(t==3)
                d= new Date(r[1],r[3],r[4],r[5],r[6],r[7]);
            else
