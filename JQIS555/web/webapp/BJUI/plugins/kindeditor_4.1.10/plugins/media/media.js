...
<<<<<<< b75ba8cbfc4cd03c0877a7594c16246138fc531c
		...
		.plugin(
				...
				function(K) {
					var self = this, name = 'media', lang = self.lang(name
							...
							.undef(self.filePostName, 'imgFile'), uploadJson = K
							.undef(self.uploadJson, self.basePath
									+ 'jsp/upload_json.jsp');
					self.plugin.media = {
						edit : function() {
							var html = [
							...
							var dialog = self
									...
									'[name="autostart"]', div);
							urlBox.val('http://');
>>>>>>> 56754004a6185f131d470343476bf0cccb89aea4
