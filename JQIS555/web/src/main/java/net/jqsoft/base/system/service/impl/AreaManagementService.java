...
import net.jqsoft.base.system.dao.AreaManagementDao;
 ...
 */
@Service
public class AreaManagementService extends BaseEntityService<AreaManagement> implements IAreaManagementService{

	@Autowired
	private AreaManagementDao areaManagementDao;

	@Override
    protected IEntityDao<AreaManagement> getDao() {
        return areaManagementDao;
    }
	@Override
...
//        map.put("projectId", entity.getProjectId());
        ...
        if (StringUtils.isNotEmpty(entity.getId())) {
            this.areaManagementDao.update(entity);
            result = 2;
        } else {
//        	entity.setProjectId(loginer.getUsername());
        	entity.setId(CommonUtil.getUUID());
        	entity.setIsDel("0");
            this.areaManagementDao.create(entity);
            result = 1;
        }
        return result;
    }
	@Override
	 public void deleteDomainInfo(String id) throws ManagerException {
			try {
				if (StringUtils.isNotBlank(id)) {
					Map<String, Object> params = new HashMap<String, Object>();
					params.put("id", id);
					areaManagementDao.update("AreaManagement.delDomainInfo", params);
				} else {
