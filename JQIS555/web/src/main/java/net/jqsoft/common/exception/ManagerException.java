 ...
 */
package net.jqsoft.common.exception;

import javassist.tools.rmi.ObjectNotFoundException;
import org.zcframework.core.exception.level.BizException;
...
/**
 * 是所有在框架端异常类的父类，其他任何业务异常必须继承这个父类
 *
 * @author jinliang
 * @create 2016-11-22 下午 1:38
 **/
public class ManagerException extends BizException {
